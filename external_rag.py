...
class PyPiFetcher(LiveDocFetcher):
    def fetch(self, package_name: str) -> str:
        ...
        try:
            ...
            logging.error(f"PyPiFetcher failed for {package_name}: {e}")
            return ""
    ...
    def fetch(self, crate_name: str) -> str:
        ...
        try:
            ...
            try:
                ...
                logging.error(f"CratesIoFetcher failed for {crate_name}: {e}")
                return ""
...
class DuckDuckGoFetcher(LiveDocFetcher):
    def fetch(self, query: str) -> str:
        ...
        try:
            ...
            logging.error(f"DuckDuckGoFetcher failed for query '{query}': {e}")
            return ""
